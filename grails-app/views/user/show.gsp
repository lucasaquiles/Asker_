            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.longi.label" default="Longi" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "longi")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.lat.label" default="Lat" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "lat")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.questions.label" default="Questions" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:formatBoolean boolean="${userInstance?.status}" /></td>
