...
class ResponseController {
    ...
    def addResponse = {
    	...
    	response.responseUser = User.get(params.aid)
    	response.question = Question.get(params.qid)
    ...
    def addPontos = {
    	...
    	if(q){
    		...
    		if(q.pontos){
	    		render "${q.pontos}"
	    		q.pontos += Integer.parseInt(params.pontos)
    		}else{
    			q.pontos = Integer.parseInt(params.pontos)
    		}
    		...
    		if(q.save()){
    			...
    			render "1 ${q.pontos} -- ${params.pontos}"	
    		}else{
